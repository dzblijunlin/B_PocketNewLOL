...
public class PictureRefreshHeaderView extends ImageView implements SwipeRefreshTrigger, SwipeTrigger {
    public PictureRefreshHeaderView(Context context) {
        super(context);
    }

    public PictureRefreshHeaderView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
