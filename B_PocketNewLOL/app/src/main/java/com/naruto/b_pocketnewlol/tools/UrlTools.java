package com.naruto.b_pocketnewlol.tools;

/**
 * Created by 大嘴宝 on 16/12/20.
 */
// 命名规范 public static final String 当前页_自定义名称
...
public class UrlTools {
    ...
    public static final String DISCOVERY_NEW_PHOTO = "http://qt.qq.com/php_cgi/lol_goods/varcache_wallpaper_list.php?type=new&page=0&num=20&plat=android&version=9715";
    public static final String NEW_MORE_PHOTO_HEAD = "http://qt.qq.com/php_cgi/lol_goods/varcache_wallpaper_list.php?type=new&page=";
    public static final String NEW_MORE_PHOTO_TAIL = "&num=20&plat=android&version=9715";
    public static final String HOT_MORE_PHOTO_HEAD = "http://qt.qq.com/php_cgi/lol_goods/varcache_wallpaper_list.php?type=hot&page=";
    public static final String HOT_MORE_PHOTO_TAIL = "&num=20&plat=android&version=9713";
    ...
    public static final String ME_LOL_HEAD = "http://api.m.panda.tv/ajax_get_live_list_by_cate?cate=";
    public static final String ME_LOL_MID = "&pageno=";
    public static final String ME_LOL_FOOTER = "&pagenum=20&__version=1.1.8.1405&__plat=android";
    ...
    public static final String ME_ALL_HEAD = "http://api.m.panda.tv/ajax_live_lists?pageno=";
    public static final String ME_ALL_FOOTER = "&pagenum=20&status=2&order=person_num&sproom=1&__version=2.1.3.1585&__plat=android&banner=1";
